...
class HPF2PControlPanel extends JDialog implements ActionListener {
	/**
	 *
	 */
	...
	public HPF2PControlPanel(HPF2PCADBlock lpf1pcadBlock) {
		super(SpinCADFrame.getInstance(), "Hi pass 2 pole");
	...
	private void createAndShowUI() {
		SwingUtilities.invokeLater(new Runnable() {
			public void run() {
				...
				int qSliderPosition = (int)(hPF.getQ() * 10);
	...
	class LPF1PChangeListener implements ChangeListener {
		public void stateChanged(ChangeEvent ce) {
			if(ce.getSource() == freqSlider) {
				...
				hPF.setQ((double) qSlider.getValue() / 10.0);
				updateQLabel();
			}
		}
	}
	...
	public void updateQLabel() {
		qField.setText(" Q " + String.format("%3.1f", hPF.getQ()));
	}
