...
public class reverbACADBlock extends SpinCADBlock {
	...
	public reverbACADBlock(int x, int y) {
		...
		addControlInputPin(this, "Pre-Delay");
		addControlInputPin(this, "HF_Damping");
		// if any control panel elements declared, set hasControlPanel to true
		hasControlPanel = true;
		System.out.println("FiltToFreq(FreqToFilt(500) = " + filtToFreq(freqToFilt(500)));
		System.out.println("logvalToSlider(SliderToLogVal(50)) = " + logvalToSlider(sliderToLogval(50, 100.0), 100.0));
	}

	// In the event there are parameters editable by control panel
	public void editBlock(){ 
		if(cp == null) {			if(hasControlPanel == true) {
	...
	public void generateCode(SpinFXBlock sfxb) {
		...
		sp = this.getPin("Pre-Delay").getPinConnection();
		int input1 = -1;
		if(sp != null) {
		...
		System.out.println("Reverb code gen!");	
	}
