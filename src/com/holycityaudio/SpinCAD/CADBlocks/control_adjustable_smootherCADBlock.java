 ...
 * control_adjustable_smootherCADBlock.java
...
public class control_adjustable_smootherCADBlock extends SpinCADBlock {

	private static final long serialVersionUID = 1L;

	private double filt = 0.00015;	// default value is ~1.0 Hz
	private control_adjustable_smootherControlPanel cp = null;

	public control_adjustable_smootherCADBlock(int x, int y) {
		super(x, y);
		setName("Adj Smoother");
	...
	public void editBlock(){
		if(cp == null) {
			if(hasControlPanel == true) {
				cp = new control_adjustable_smootherControlPanel(this);
			}
		}
	}
