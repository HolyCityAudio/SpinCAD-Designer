...
public class ClipControlControlPanel implements ChangeListener, ActionListener, ItemListener {
	...
	private FineControlSlider gainSlider = new FineControlSlider(JSlider.HORIZONTAL, 100, 1000, 200);
	...
	private void updateGainField() {
		gainField.setText(String.format("%2.2f", pC.getGain()));
	}
