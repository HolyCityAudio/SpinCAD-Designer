...
}
{
	...
	SpinCADPin p2 = m.getPin("Input_R");
	p2.setConnection(i, p1);
}
{
...
f.getModel().sortAlignGen();
System.out.println("dance_ir_fla_lCADBlock test passed with all audio and no control connections!");
...
//==========================================================
	...
	f.getModel().sortAlignGen();
	System.out.println("dance_ir_fla_lCADBlock test passed with all connections!");
//==========================================================
// end of test code
