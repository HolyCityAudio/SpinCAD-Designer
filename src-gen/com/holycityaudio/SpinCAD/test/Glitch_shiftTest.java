...
public class Glitch_shiftTest {
	public Glitch_shiftTest(SpinCADFrame f) {
		System.out.println("Start of Glitch_shiftCADBlock unit test..." + "\n");

		SpinCADPanel p = new SpinCADPanel(f);
		InputCADBlock i = new InputCADBlock(225, 10);
		OutputCADBlock o = new OutputCADBlock(225, 290);
		Glitch_shiftCADBlock m = new Glitch_shiftCADBlock(225, 210);
f.dropBlock(p, m);	

f.getModel().sortAlignGen();
System.out.println("Glitch_shiftCADBlock test passed with no connections!");
f.getModel().newModel();
...
}
{
	...
	SpinCADPin p2 = m.getPin("Glitch Out");
...
f.getModel().sortAlignGen();
System.out.println("Glitch_shiftCADBlock test passed with all control connections!");

f.getModel().newModel();	

// end of test code
	System.out.println("End of Glitch_shiftCADBlock unit test" + "\n");
	}
}
