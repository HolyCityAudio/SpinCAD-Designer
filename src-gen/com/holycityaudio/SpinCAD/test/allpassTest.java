...
public class allpassTest {
	public allpassTest(SpinCADFrame f) {
		System.out.println("Start of allpassCADBlock unit test..." + "\n");

		SpinCADPanel p = new SpinCADPanel(f);
		InputCADBlock i = new InputCADBlock(225, 10);
		OutputCADBlock o = new OutputCADBlock(225, 290);
		allpassCADBlock m = new allpassCADBlock(225, 210);
f.dropBlock(p, m);	

f.getModel().sortAlignGen();
System.out.println("allpassCADBlock test passed with no connections!");
f.getModel().newModel();
...
// end of test code
	System.out.println("End of allpassCADBlock unit test" + "\n");
	}
}
