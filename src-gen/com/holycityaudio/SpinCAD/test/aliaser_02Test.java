...
public class aliaser_02Test {
	public aliaser_02Test(SpinCADFrame f) {
		System.out.println("Start of aliaser_02CADBlock unit test..." + "\n");

		SpinCADPanel p = new SpinCADPanel(f);
		InputCADBlock i = new InputCADBlock(225, 10);
		OutputCADBlock o = new OutputCADBlock(225, 290);
		aliaser_02CADBlock m = new aliaser_02CADBlock(225, 210);
f.dropBlock(p, m);	

f.getModel().sortAlignGen();
System.out.println("aliaser_02CADBlock test passed with no connections!");
f.getModel().newModel();
...
f.getModel().sortAlignGen();
System.out.println("aliaser_02CADBlock test passed with all control connections!");

f.getModel().newModel();	

// end of test code
	System.out.println("End of aliaser_02CADBlock unit test" + "\n");
	}
}
