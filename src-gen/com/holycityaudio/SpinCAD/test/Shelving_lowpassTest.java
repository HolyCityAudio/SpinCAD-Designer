...
public class Shelving_lowpassTest {
	public Shelving_lowpassTest(SpinCADFrame f) {
		System.out.println("Start of Shelving_lowpassCADBlock unit test..." + "\n");

		SpinCADPanel p = new SpinCADPanel(f);
		InputCADBlock i = new InputCADBlock(225, 10);
		OutputCADBlock o = new OutputCADBlock(225, 290);
		Shelving_lowpassCADBlock m = new Shelving_lowpassCADBlock(225, 210);
f.dropBlock(p, m);	

f.getModel().sortAlignGen();
System.out.println("Shelving_lowpassCADBlock test passed with no connections!");
f.getModel().newModel();
...
f.getModel().sortAlignGen();
System.out.println("Shelving_lowpassCADBlock test passed with all control connections!");

f.getModel().newModel();	

// end of test code
	System.out.println("End of Shelving_lowpassCADBlock unit test" + "\n");
	}
}
