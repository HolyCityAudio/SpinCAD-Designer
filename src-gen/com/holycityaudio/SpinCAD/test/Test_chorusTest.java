...
public class Test_chorusTest {
	public Test_chorusTest(SpinCADFrame f) {
		System.out.println("Start of Test_chorusCADBlock unit test..." + "\n");

		SpinCADPanel p = new SpinCADPanel(f);
		InputCADBlock i = new InputCADBlock(225, 10);
		OutputCADBlock o = new OutputCADBlock(225, 290);
		Test_chorusCADBlock m = new Test_chorusCADBlock(225, 210);
f.dropBlock(p, m);	

f.getModel().sortAlignGen();
System.out.println("Test_chorusCADBlock test passed with no connections!");
f.getModel().newModel();
...
f.getModel().sortAlignGen();
System.out.println("Test_chorusCADBlock test passed with all control connections!");

f.getModel().newModel();	

// end of test code
	System.out.println("End of Test_chorusCADBlock unit test" + "\n");
	}
}
