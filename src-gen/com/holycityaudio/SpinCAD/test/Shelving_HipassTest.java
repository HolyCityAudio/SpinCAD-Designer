...
public class Shelving_HipassTest {
	public Shelving_HipassTest(SpinCADFrame f) {
		System.out.println("Start of Shelving_HipassCADBlock unit test..." + "\n");

		SpinCADPanel p = new SpinCADPanel(f);
		InputCADBlock i = new InputCADBlock(225, 10);
		OutputCADBlock o = new OutputCADBlock(225, 290);
		Shelving_HipassCADBlock m = new Shelving_HipassCADBlock(225, 210);
f.dropBlock(p, m);	

f.getModel().sortAlignGen();
System.out.println("Shelving_HipassCADBlock test passed with no connections!");
f.getModel().newModel();
...
// end of test code
	System.out.println("End of Shelving_HipassCADBlock unit test" + "\n");
	}
}
