...
public class pitchupdownTest {
	public pitchupdownTest(SpinCADFrame f) {
		System.out.println("Start of pitchupdownCADBlock unit test..." + "\n");

		SpinCADPanel p = new SpinCADPanel(f);
		InputCADBlock i = new InputCADBlock(225, 10);
		OutputCADBlock o = new OutputCADBlock(225, 290);
		pitchupdownCADBlock m = new pitchupdownCADBlock(225, 210);
f.dropBlock(p, m);	

f.getModel().sortAlignGen();
System.out.println("pitchupdownCADBlock test passed with no connections!");
f.getModel().newModel();
...
}
{
	...
	SpinCADPin p2 = m.getPin("Pitch_Down_Out");
...
// end of test code
	System.out.println("End of pitchupdownCADBlock unit test" + "\n");
	}
}
