...
public class tremolizerTest {
	public tremolizerTest(SpinCADFrame f) {
		System.out.println("Start of tremolizerCADBlock unit test..." + "\n");

		SpinCADPanel p = new SpinCADPanel(f);
		InputCADBlock i = new InputCADBlock(225, 10);
		OutputCADBlock o = new OutputCADBlock(225, 290);
		tremolizerCADBlock m = new tremolizerCADBlock(225, 210);
f.dropBlock(p, m);	

f.getModel().sortAlignGen();
System.out.println("tremolizerCADBlock test passed with no connections!");
f.getModel().newModel();
...
f.getModel().sortAlignGen();
System.out.println("tremolizerCADBlock test passed with all control connections!");

f.getModel().newModel();	

// end of test code
	System.out.println("End of tremolizerCADBlock unit test" + "\n");
	}
}
