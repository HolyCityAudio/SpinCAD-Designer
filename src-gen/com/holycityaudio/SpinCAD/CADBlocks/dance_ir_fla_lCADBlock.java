 ...
 */ 
	...
	//			new dance_ir_fla_lControlPanel(this);
			}	
			...
			if(this.getPin("Input_L").getPinConnection() != null) {
			//			System.out.println("IsPinConnected! " + "Input_L"); 
			sfxb.skip(RUN, 1);
			sfxb.loadRampLFO(RMP0, 0, 512);
			if(this.getPin("Reverb_Time").getPinConnection() != null) {
			//			System.out.println("IsPinConnected! " + "Reverb_Time"); 
			...
			if(this.getPin("Low_Pass").getPinConnection() != null) {
			//			System.out.println("IsPinConnected! " + "Low_Pass"); 
			...
			if(this.getPin("Flange").getPinConnection() != null) {
			//			System.out.println("IsPinConnected! " + "Flange"); 
			...
			// Say 'bye-bye'
			// System.out.println("Infinite_Rev_Flange" + " code gen!");
			}
