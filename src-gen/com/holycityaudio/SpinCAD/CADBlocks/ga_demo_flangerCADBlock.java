 ...
 */ 
	...
	//			new ga_demo_flangerControlPanel(this);
			}	
			...
			sfxb.loadRampLFO(RMP0, 0, 4096);
			sfxb.loadRampLFO(RMP1, 0, 512);
			...
			if(this.getPin("Reverb_Level").getPinConnection() != null) {
			//			System.out.println("IsPinConnected! " + "Reverb_Level"); 
			...
			if(this.getPin("Effect_Level_Feedback").getPinConnection() != null) {
			//			System.out.println("IsPinConnected! " + "Effect_Level_Feedback"); 
			...
			if(this.getPin("Flange_Rate").getPinConnection() != null) {
			//			System.out.println("IsPinConnected! " + "Flange_Rate"); 
