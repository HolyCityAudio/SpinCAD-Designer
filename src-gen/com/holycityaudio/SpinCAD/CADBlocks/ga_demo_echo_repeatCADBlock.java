 ...
 */ 
	...
	//			new ga_demo_echo_repeatControlPanel(this);
			}	
			...
			if(this.getPin("Delay_Level").getPinConnection() != null) {
			//			System.out.println("IsPinConnected! " + "Delay_Level"); 
			sfxb.mulx(input2);
			sfxb.mulx(input2);
			} else {
			...
			// Say 'bye-bye'
			// System.out.println("Repeat_echo" + " code gen!");
			}
