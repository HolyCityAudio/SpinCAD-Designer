 ...
 */ 
	...
	//			new ga_demo_chorusControlPanel(this);
			}	
			...
			if(this.getPin("Chorus_Rate").getPinConnection() != null) {
			//			System.out.println("IsPinConnected! " + "Chorus_Rate"); 
			...
			if(this.getPin("Effect_Level").getPinConnection() != null) {
			//			System.out.println("IsPinConnected! " + "Effect_Level"); 
			sfxb.mulx(input2);
			} else {
			...
			// Say 'bye-bye'
			// System.out.println("GA_Demo_Chorus" + " code gen!");
			}
