 ...
 */ 
	...
	//			new shimmer_verbControlPanel(this);
			}	
			...
			sfxb.skip(RUN, 1);
			sfxb.loadRampLFO(RMP0, 16384, 4096);
			if(this.getPin("Decay").getPinConnection() != null) {
			//			System.out.println("IsPinConnected! " + "Decay"); 
			...
			if(this.getPin("Damping").getPinConnection() != null) {
			//			System.out.println("IsPinConnected! " + "Damping"); 
			...
			if(this.getPin("Feedback").getPinConnection() != null) {
			//			System.out.println("IsPinConnected! " + "Feedback"); 
			...
			// Say 'bye-bye'
			// System.out.println("Shimmer_reverb" + " code gen!");
			}
