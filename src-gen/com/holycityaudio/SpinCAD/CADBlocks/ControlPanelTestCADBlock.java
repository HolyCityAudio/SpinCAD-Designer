 ...
 */ 
		...
		import com.holycityaudio.SpinCAD.SpinFXBlock;
 		import com.holycityaudio.SpinCAD.ControlPanel.ControlPanelTestControlPanel;
		
	    @SuppressWarnings("unused")
	    public class ControlPanelTestCADBlock extends SpinCADBlock {
			private static final long serialVersionUID = 1L;
			private ControlPanelTestControlPanel cp = null;
			
			private double pitchCoeff = 8192;
			private double pitchCoeff1 = 8192;
			private double pitchCoeff2 = 8192;
			private double pitchCoeff3 = 8192;
			private double pitchCoeff4 = 8192;
			private double pitchCoeff5 = 8192;
			...
			public ControlPanelTestCADBlock(int x, int y) {
				super(x, y);
				setName("Control Panel Test");					
			...
			public void editBlock(){ 
				if(cp == null) {
					if(hasControlPanel == true) {
						cp = new ControlPanelTestControlPanel(this);
					}
				}
			}
			...
			public void setpitchCoeff1(double __param) {
				pitchCoeff1 = __param;	
			}
			
			public double getpitchCoeff1() {
				return pitchCoeff1;
			}
			public void setpitchCoeff2(double __param) {
				pitchCoeff2 = __param;	
			}
			
			public double getpitchCoeff2() {
				return pitchCoeff2;
			}
