 ...
 */ 
	...
	//			new ga_demo_wahControlPanel(this);
			}	
			...
			sfxb.readRegister(avg, 1);
			sfxb.log(1, 0);
			if(this.getPin("Wah_Sens").getPinConnection() != null) {
			//			System.out.println("IsPinConnected! " + "Wah_Sens"); 
			...
			if(this.getPin("Wah_Level_Q").getPinConnection() != null) {
			//			System.out.println("IsPinConnected! " + "Wah_Level_Q"); 
			...
			// Say 'bye-bye'
			// System.out.println("Wah" + " code gen!");
			}
