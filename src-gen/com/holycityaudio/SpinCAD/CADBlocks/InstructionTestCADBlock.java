 ...
 */ 
	...
	//			new InstructionTestControlPanel(this);
			}	
			...
			sfxb.xor(0xAA55);
			sfxb.xor(0x55AA);
			if(this.getPin("Reverb").getPinConnection() != null) {
			//			System.out.println("IsPinConnected! " + "Reverb"); 
			sfxb.and(0xFEEEEE);
			sfxb.and(0x15);
			sfxb.and(0xAA55);
			} else {
			...
			sfxb.loadRampLFO(RMP0, 30, 512);
			sfxb.loadRampLFO(RMP1, 134, 4096);
			...
			// Say 'bye-bye'
			// System.out.println("Instruction_Test" + " code gen!");
			}
