 ...
 */ 
		...
		import com.holycityaudio.SpinCAD.SpinFXBlock;
 		import com.holycityaudio.SpinCAD.ControlPanel.Chirp-duplicateControlPanel;
		
	    @SuppressWarnings("unused")
	    public class Chirp-duplicateCADBlock extends SpinCADBlock {
			private static final long serialVersionUID = 1L;
			private Chirp-duplicateControlPanel cp = null;
			...
			public Chirp-duplicateCADBlock(int x, int y) {
				super(x, y);
				setName("Chirp2");					
			...
			public void editBlock(){ 
				if(cp == null) {
					if(hasControlPanel == true) {
						cp = new Chirp-duplicateControlPanel(this);
					}
				}
			}
