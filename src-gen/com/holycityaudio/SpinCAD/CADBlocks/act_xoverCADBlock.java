 ...
 */ 
	...
	//			new act_xoverControlPanel(this);
			}	
			...
			this.getPin("Output_L").setRegister(output1);
			this.getPin("Output_R").setRegister(output2);
			...
			// Say 'bye-bye'
			// System.out.println("Active_Crossover" + " code gen!");
			}
