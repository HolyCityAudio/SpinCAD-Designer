 ...
 */ 
	...
	//			new ga_demo_phaserControlPanel(this);
			}	
			...
			this.getPin("Audio_Output_2").setRegister(output1);
			...
			if(this.getPin("Phase_Width").getPinConnection() != null) {
			//			System.out.println("IsPinConnected! " + "Phase_Width"); 
			...
			if(this.getPin("Phase_Rate").getPinConnection() != null) {
			//			System.out.println("IsPinConnected! " + "Phase_Rate"); 
