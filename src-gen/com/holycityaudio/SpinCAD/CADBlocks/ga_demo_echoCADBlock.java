 ...
 */ 
		...
		public class ga_demo_echoCADBlock extends SpinCADBlock {
			...
			private double krs;
			private double fbk;
			private double default_delay_time;
	...
	//			new ga_demo_echoControlPanel(this);
			}	
			...
			if(this.getPin("Delay_Time").getPinConnection() != null) {
			//			System.out.println("IsPinConnected! " + "Delay_Time"); 
			...
			if(this.getPin("Echo_Level").getPinConnection() != null) {
			//			System.out.println("IsPinConnected! " + "Echo_Level"); 
			sfxb.mulx(input2);
			sfxb.mulx(input2);
			} else {
			...
			// Say 'bye-bye'
			// System.out.println("Echo" + " code gen!");
			}
