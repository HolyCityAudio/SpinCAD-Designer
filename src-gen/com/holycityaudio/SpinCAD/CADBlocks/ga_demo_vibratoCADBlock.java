 ...
 */ 
	...
	//			new ga_demo_vibratoControlPanel(this);
			}	
			...
			if(this.getPin("Vibrato_Rate").getPinConnection() != null) {
			//			System.out.println("IsPinConnected! " + "Vibrato_Rate"); 
			...
			if(this.getPin("Vibrato_Width").getPinConnection() != null) {
			//			System.out.println("IsPinConnected! " + "Vibrato_Width"); 
			...
			// Say 'bye-bye'
			// System.out.println("Vibrato" + " code gen!");
			}
