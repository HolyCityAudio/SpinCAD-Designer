 ...
 */ 
		...
		import com.holycityaudio.SpinCAD.SpinFXBlock;
 		import com.holycityaudio.SpinCAD.ControlPanel.DrumDelaySrcControlPanel;
		
	    @SuppressWarnings("unused")
	    public class DrumDelaySrcCADBlock extends SpinCADBlock {
			private static final long serialVersionUID = 1L;
			private DrumDelaySrcControlPanel cp = null;
			...
			public DrumDelaySrcCADBlock(int x, int y) {
				super(x, y);
				setName("Drum Delay");					
			setBorderColor(new Color(0x6062c4));
			...
			public void editBlock(){ 
				if(cp == null) {
					if(hasControlPanel == true) {
						cp = new DrumDelaySrcControlPanel(this);
					}
				}
			}
