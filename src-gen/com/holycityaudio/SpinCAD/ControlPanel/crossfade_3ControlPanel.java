...
public crossfade_3ControlPanel(crossfade_3CADBlock genericCADBlock) {
		...
		SwingUtilities.invokeLater(new Runnable() {
			public void run() {
				...
				frame = new JDialog(SpinCADFrame.getInstance(), "Crossfade 3");
			...
			//
					...
					// dB level slider: multiplier sets steps per dB (e.g. 10 = 0.1 dB steps)
						...
						gain1Slider.addChangeListener(new crossfade_3Listener());
			...
			//
					...
					// dB level slider: multiplier sets steps per dB (e.g. 10 = 0.1 dB steps)
						...
						gain2Slider.addChangeListener(new crossfade_3Listener());
