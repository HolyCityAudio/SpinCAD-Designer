...
public Shelving_lowpassControlPanel(Shelving_lowpassCADBlock genericCADBlock) {
		...
		SwingUtilities.invokeLater(new Runnable() {
			public void run() {
				...
				frame = new JDialog(SpinCADFrame.getInstance(), "Shelving Lowpass");
			...
			//
					...
					// dB level slider goes in steps of 1 dB
						...
						shelfField.setBorder(shelfBorder1);
						...
						shelfinnerPanel.add(shelfField);
						shelfinnerPanel.add(Box.createRigidArea(new Dimension(5,4)));
