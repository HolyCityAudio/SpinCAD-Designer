 ...
 * peak_compressorControlPanel.java
...
public class peak_compressorControlPanel extends spinCADControlPanel {
	private JDialog frame;
	private peak_compressorCADBlock gCB;
...
public peak_compressorControlPanel(peak_compressorCADBlock genericCADBlock) {
		...
		SwingUtilities.invokeLater(new Runnable() {
			public void run() {
				...
				frame = new JDialog(SpinCADFrame.getInstance(), "Peak_Compressor");
			...
			//
					inGainSlider = new FineControlSlider(JSlider.HORIZONTAL, (int)(0.1 * 100.0),(int) (2.0 * 100.0), (int) (gCB.getinGain() * 100.0));
						inGainSlider.addChangeListener(new peak_compressorListener());
			...
			//
					ratioSlider = new FineControlSlider(JSlider.HORIZONTAL, (int)(1.5 * 10.0),(int) (100.0 * 10.0), (int) (gCB.getratio() * 10.0));
						ratioSlider.addChangeListener(new peak_compressorListener());
			...
			//
					threshDbSlider = new FineControlSlider(JSlider.HORIZONTAL, (int)(-50.0 * 10.0),(int) (-5.0 * 10.0), (int) (gCB.getthreshDb() * 10.0));
						threshDbSlider.addChangeListener(new peak_compressorListener());
			...
			//
					makeupDbSlider = new FineControlSlider(JSlider.HORIZONTAL, (int)(0.0 * 10.0),(int) (30.0 * 10.0), (int) (gCB.getmakeupDb() * 10.0));
						makeupDbSlider.addChangeListener(new peak_compressorListener());
			...
			//
					trimSlider = new FineControlSlider(JSlider.HORIZONTAL, (int)(0.25 * 100.0),(int) (2.0 * 100.0), (int) (gCB.gettrim() * 100.0));
						trimSlider.addChangeListener(new peak_compressorListener());
		...
		class peak_compressorListener implements ChangeListener { 
		...
		class peak_compressorItemListener implements java.awt.event.ItemListener { 
