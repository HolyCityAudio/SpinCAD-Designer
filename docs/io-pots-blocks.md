...
These blocks provide access to the FV-1's audio converters and hardware potentiometer inputs.

| Block                                          | Description                   |
| ---------------------------------------------- | ----------------------------- |
| [Input](io-pots-blocks.md#input)               | Stereo ADC input              |
| [Output](io-pots-blocks.md#output)             | Stereo DAC output             |
| [Pot 0 / 1 / 2](io-pots-blocks.md#pot-0--1--2) | Hardware potentiometer inputs |
...
![Output control panel](.gitbook/assets/io-output-panel.png)
...
![Bypass patch](.gitbook/assets/io-bypass-block.png)

***

## Pot 0 / 1 / 2

Each Pot block reads one of the FV-1's three hardware potentiometers (POT0, POT1, POT2) and outputs its value as a control signal. The Pot blocks are the primary way to give the end user real-time control over a patch's parameters.
