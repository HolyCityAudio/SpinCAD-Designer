...
SpinCAD Designer would not exist without the contributions and inspiration of the following people:
...
{% hint style="info" %}
Note that the underlying block code in many blocks was taken from one or more of these public sources and adapted for use in SpinCAD.  In some cases the functionality has been expanded.

* [Spin Free Programs](https://spinsemi.com/programs.php)
* [Spin Knowledge Base](https://spinsemi.com/knowledge_base/pgm_quick.html)
* [The Spin Forum](https://www.spinsemi.com/forum/index.php)
* [Mark Stratman's Github archive](https://mstratman.github.io/fv1-programs/)
{% endhint %}
